...
原理，将unicode的 \u 先转为 %u，然后使用unescape方法转换为中文。
    ...
    <li class="alt"><span><span><script&nbsp;type=</span><span class="string">"text/javascript"</span><span>>&nbsp;&nbsp;</span></span></li><li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">var</span><span>&nbsp;str&nbsp;=&nbsp;</span><span class="string">"\u7434\u5fc3\u5251\u9b44\u4eca\u4f55\u5728\uff0c\u6c38\u591c\u521d\u6657\u51dd\u78a7\u5929\u3002"</span><span>;&nbsp;&nbsp;</span></span></li><li class="alt"><span>&nbsp;&nbsp;&nbsp;&nbsp;document.write(unescape(str.replace(/\\u/g,&nbsp;<span class="string">'%u'</span><span>)));&nbsp;</span><span class="comment">//琴心剑魄今何在，永夜初晗凝碧天。</span><span>&nbsp;&nbsp;</span></span></li><li class=""><span></script>&nbsp;&nbsp;</span></li>
...
> array.splice(start, deleteCount[, item1[, item2[, ...]]])
    ...
    // myFish is ['angel', 'clown', 'drum', 'surgeon'] ,removed is ['mandarin']

	removed = myFish.splice(2, 1, 'trumpet');
    // removes 1 element from index 2, and inserts 'trumpet',
    // myFish is ['angel', 'clown', 'trumpet', 'surgeon'],removed is ['drum']
